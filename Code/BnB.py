...
def BranchnBound(G, cutoff, trace_file):
...
def main(graph_file, output_dir, cutoff, randSeed):
    ...
    solution_file = "Output/" + graph_file[5:-6] + "_BnB_" + str(int(cutoff)) + "_" + str(randSeed) + ".sol"
    trace_file = "Output/" + graph_file[5:-6] + "_BnB_" + str(int(cutoff)) + "_" + str(randSeed) + ".trace"
    ...
    sol = BranchnBound(G1, cutoff, trace_file)
